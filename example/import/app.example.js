...
/******/ 	return __webpack_require__(__webpack_require__.s = "./example/import/app.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./dist/css/toastr.min.css":
/*!*********************************!*\
  !*** ./dist/css/toastr.min.css ***!
  \*********************************/
...
eval("var api = __webpack_require__(/*! ../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ \"./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js\");\n            var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./toastr.min.css */ \"./node_modules/css-loader/dist/cjs.js!./dist/css/toastr.min.css\");\n\n            content = content.__esModule ? content.default : content;\n\n            if (typeof content === 'string') {\n              content = [[module.i, content, '']];\n            }\n\nvar options = {};\n\noptions.insert = \"head\";\noptions.singleton = false;\n\nvar update = api(content, options);\n\nvar exported = content.locals ? content.locals : {};\n\n\n\nmodule.exports = exported;\n\n//# sourceURL=webpack:///./dist/css/toastr.min.css?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_toastr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../src/toastr */ \"./src/toastr.js\");\n/* harmony import */ var _src_toastr__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_src_toastr__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _dist_css_toastr_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../dist/css/toastr.min.css */ \"./dist/css/toastr.min.css\");\n/* harmony import */ var _dist_css_toastr_min_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_dist_css_toastr_min_css__WEBPACK_IMPORTED_MODULE_1__);\n\r\n\r\n\r\nconst toastr = new _src_toastr__WEBPACK_IMPORTED_MODULE_0___default.a({\r\n  position: 'top-right',\r\n  animate: true,\r\n  animation: 'fade',\r\n  timeout: 100000\r\n});\r\n\r\n/**\r\n * @type { HTMLSelectElement }\r\n */\r\nlet select = document.createElement('select');\r\nlet positions = [\r\n  'top-right',\r\n  'top-left',\r\n  'top-center',\r\n  'bottom-right',\r\n  'bottom-left',\r\n  'bottom-center'\r\n];\r\nlet buttons = [\r\n  'success',\r\n  'error',\r\n  'warning',\r\n  'info'\r\n]\r\n\r\nfunction init() {\r\n  for (let i = 0; i < positions.length; i++) {\r\n    const option = document.createElement('option');\r\n    option.value = positions[i];\r\n    option.innerText = positions[i];\r\n    select.appendChild(option);\r\n  }\r\n\r\n  for (let i = 0; i < buttons.length; i++) {\r\n    const button = document.getElementById(buttons[i]);\r\n    if (button) button.onclick = () => toastr[buttons[i]](`${buttons[i]} test`);\r\n  }\r\n\r\n  select.classList.add('pure-input');\r\n  select.onchange = updatePosition;\r\n  document.getElementById('form').appendChild(select);\r\n}\r\n\r\nfunction updatePosition(e) {\r\n  toastr.updateConfig({\r\n    position: select.value\r\n  });\r\n\r\n  toastr.success(`Position changed to ${select.value.split('-').join(' ')}`);\r\n}\r\n\r\nwindow.onload = init;\r\n\n\n//# sourceURL=webpack:///./example/import/app.js?");

/***/ }),

/***/ "./node_modules/css-loader/dist/cjs.js!./dist/css/toastr.min.css":
/*!***********************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./dist/css/toastr.min.css ***!
  \***********************************************************************/
/*! no static exports found */
...
eval("// Imports\nvar ___CSS_LOADER_API_IMPORT___ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\nexports = ___CSS_LOADER_API_IMPORT___(false);\n// Module\nexports.push([module.i, \".animated{animation-duration:1s;animation-fill-mode:both}.animated.infinite{animation-iteration-count:infinite}.animated.delay-1s{animation-delay:1s}.animated.delay-2s{animation-delay:2s}.animated.delay-3s{animation-delay:3s}.animated.delay-4s{animation-delay:4s}.animated.delay-5s{animation-delay:5s}.animated.fast{animation-duration:800ms}.animated.faster{animation-duration:500ms}.animated.slow{animation-duration:2s}.animated.slower{animation-duration:3s}@media (print), (prefers-reduced-motion: reduce){.animated{animation-duration:1ms !important;transition-duration:1ms !important;animation-iteration-count:1 !important}}.animated{--animate-duration: 1s;--animate-delay: 1s}@keyframes fadeIn{from{opacity:0}to{opacity:1}}.fadeIn{animation-name:fadeIn}@keyframes fadeInDown{from{opacity:0;transform:translate3d(0, -100%, 0)}to{opacity:1;transform:translate3d(0, 0, 0)}}.fadeInDown{animation-name:fadeInDown}@keyframes fadeInUp{from{opacity:0;transform:translate3d(0, 100%, 0)}to{opacity:1;transform:translate3d(0, 0, 0)}}.fadeInUp{animation-name:fadeInUp}@keyframes fadeInLeft{from{opacity:0;transform:translate3d(-100%, 0, 0)}to{opacity:1;transform:translate3d(0, 0, 0)}}.fadeInLeft{animation-name:fadeInLeft}@keyframes fadeInRight{from{opacity:0;transform:translate3d(100%, 0, 0)}to{opacity:1;transform:translate3d(0, 0, 0)}}.fadeInRight{animation-name:fadeInRight}@keyframes fadeOut{from{opacity:1}to{opacity:0}}.fadeOut{animation-name:fadeOut}@keyframes fadeOutDown{from{opacity:1}to{opacity:0;transform:translate3d(0, 100%, 0)}}.fadeOutDown{animation-name:fadeOutDown}@keyframes fadeOutUp{from{opacity:1}to{opacity:0;transform:translate3d(0, -100%, 0)}}.fadeOutUp{animation-name:fadeOutUp}@keyframes fadeOutLeft{from{opacity:1}to{opacity:0;transform:translate3d(-100%, 0, 0)}}.fadeOutLeft{animation-name:fadeOutLeft}@keyframes fadeOutRight{from{opacity:1}to{opacity:0;transform:translate3d(100%, 0, 0)}}.fadeOutRight{animation-name:fadeOutRight}.toastr-container{position:fixed;z-index:10000}.toastr-container.top-right{top:10px;right:20px;text-align:right}.toastr-container.top-left{top:10px;left:20px;text-align:left}.toastr-container.top-center{top:10px;left:50%;text-align:center}.toastr-container.bottom-right{bottom:10px;right:20px;text-align:right}.toastr-container.bottom-left{bottom:10px;left:20px;text-align:left}.toastr-container.bottom-center{bottom:10px;left:50%;text-align:center}.toastr-container .toastr{color:#ffffff;padding:10px 20px;margin-bottom:10px;width:fit-content;display:inline-block}.toastr-container .toastr.success{background-color:#36e278}.toastr-container .toastr.error{background-color:#e23636}.toastr-container .toastr.warning{background-color:#e2c236}.toastr-container .toastr.info{background-color:#368fe2}\\n\", \"\"]);\n// Exports\nmodule.exports = exports;\n\n\n//# sourceURL=webpack:///./dist/css/toastr.min.css?./node_modules/css-loader/dist/cjs.js");
